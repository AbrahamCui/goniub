...
import com.rocket.terminal.LinuxTerminalHelper;
import com.rocket.util.Boot;
...
@Slf4j
public class RocketChromeOptions extends ChromeOptions {
    ...
    private static final String dir = tmpdir + File.separator + "chrome_file_data_cache" + File.separator + 1;
    ...
    public RocketChromeOptions() {
        this(false, false, false);
    }

    public RocketChromeOptions(boolean disableLoadImage, boolean headless, boolean isAPP) {
        this(disableLoadImage, headless, true, null, CHROME_USER_AGENT, isAPP);
    }

    public RocketChromeOptions(boolean disableLoadImage, boolean headless) {
        this(disableLoadImage, headless, true, null, CHROME_USER_AGENT, false);
    }


    public RocketChromeOptions(boolean disableLoadImage, boolean headless, HttpsProxy httpsProxy, String userAgent) {
        this(disableLoadImage, headless, true, httpsProxy, userAgent, false);
    }

    public RocketChromeOptions(boolean disableLoadImage, boolean headless, HttpsProxy httpsProxy, String userAgent, boolean isAPP) {
        this(disableLoadImage, headless, true, httpsProxy, userAgent, isAPP);
    }

    public RocketChromeOptions(boolean disableLoadImage, boolean headless, boolean hideFingerprint, HttpsProxy httpsProxy, String userAgent, boolean isAPP) {
...
//        System.setProperty("whitelistedIps", "");
        ...
        if (StringUtils.isBlank(TEMP_CACHE)) {
...
//			this.addArguments("--disable-extensions");
    ...
    public static void setDATA(String DATA) {
        RocketChromeOptions.DATA = DATA;
    }

    public static void setCACHE(String CACHE) {
        RocketChromeOptions.CACHE = CACHE;
    }
